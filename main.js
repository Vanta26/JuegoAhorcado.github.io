...
let listaPalabras = ['TECLADO', 'PANTALLA', 'PAGINA', 'PALABRAS', 'VOLUMEN', 'NUMEROS', 'CONECTOR', 'SALIDA', 'ESPACIO', 'BORDE'];

function pantAgregarPalabra() {
    document.getElementById("pantalla-inicio").style.display = "none";
    document.getElementById("pantalla-ingresar-palabra").style.display = "flex";
}
